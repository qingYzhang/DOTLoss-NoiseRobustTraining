...
from loss import SCELoss, DOTLoss

# ArgParse
parser = argparse.ArgumentParser(description='DOT Loss')
...
parser.add_argument('--loss', type=str, default='DOT', help='SCE, CE, DOT')
...
parser.add_argument('--version', type=str, default='DOT0.0', help='Version')
...
def train():
    ...
    if args.loss == 'SCE':
        ...
        criterion = DOTLoss(num_classes=num_classes)
    else:
